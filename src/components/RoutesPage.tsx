...
const routes: Route[] = [
  {
    id: 1,
    title: "Сердце Липецка",
    subtitle: "Архитектурные памятники исторического центра",
    duration: "2–3 часа",
    distance: "3.5 км",
    difficulty: "Лёгкий",
    stops: 5,
    description: "Пешеходный маршрут по историческому центру Липецка. Соборная площадь, старейшие храмы, парки у минеральных источников — места, связанные с именем Петра I.",
    highlights: ["Собор Рождества Христова", "Древне-Успенская церковь", "Нижний парк"],
    image: "https://cdn.poehali.dev/projects/35e99b30-aa66-45af-aba6-b153e8cdeca7/files/641250ac-a0d6-4367-9fe3-0cf0e48e7445.jpg",
    monumentIds: [2, 1, 9, 4, 3],
  },
  {
    id: 2,
    title: "Природные святыни",
    subtitle: "Заповедники и природные памятники области",
    duration: "Весь день",
    distance: "110 км",
    difficulty: "Средний",
    stops: 3,
    description: "Автомобильный маршрут к уникальным природным объектам Липецкой области. Заповедник Галичья гора, скалы девонского известняка, археопарк Аргамач.",
    highlights: ["Галичья гора", "Аргамач-Пальна", "Берега Дона"],
  ...
  },
  {
    id: 3,
    title: "Паломнический",
    subtitle: "Монастыри и святыни Липецкого края",
    duration: "5–6 часов",
    distance: "85 км",
    difficulty: "Лёгкий",
    stops: 3,
    description: "Маршрут к главным духовным центрам региона. Задонский монастырь — место паломничества к мощам св. Тихона Задонского, старейшие храмы Липецка.",
    highlights: ["Задонский монастырь", "Собор Рождества Христова", "Древне-Успенская церковь"],
    image: "https://cdn.poehali.dev/projects/35e99b30-aa66-45af-aba6-b153e8cdeca7/files/641250ac-a0d6-4367-9fe3-0cf0e48e7445.jpg",
    monumentIds: [6, 2, 1],
  },
  {
    ...
    difficulty: "Сложный",
    stops: 8,
    description: "Полный тур по всем значимым объектам региона. Охватывает памятники от средневековья до XIX века. Рекомендован транспорт.",
    highlights: ["8 ключевых объектов", "Все типы памятников", "Липецк + область"],
    image: "https://cdn.poehali.dev/projects/35e99b30-aa66-45af-aba6-b153e8cdeca7/files/641250ac-a0d6-4367-9fe3-0cf0e48e7445.jpg",
    monumentIds: [2, 1, 9, 4, 3, 6, 5, 7],
  },
];

const allMonuments = [
  { id: 1,  name: "Древне-Успенская церковь",      type: "Архитектура" },
  { id: 2,  name: "Собор Рождества Христова",       type: "Архитектура" },
  { id: 3,  name: "Нижний парк",                    type: "Природа"     },
  { id: 4,  name: "Верхний парк",                   type: "Природа"     },
  { id: 5,  name: "Заповедник «Галичья гора»",     type: "Природа"     },
  { id: 6,  name: "Задонский монастырь",             type: "Архитектура" },
  { id: 7,  name: "Археопарк «Аргамач»",           type: "Археология"  },
  { id: 8,  name: "Липецкий краеведческий музей",   type: "Культура"    },
  { id: 9,  name: "Путевой дворец Петра I",         type: "Архитектура" },
  { id: 10, name: "Центр романовской игрушки",      type: "Культура"    },
];
