...
const monuments: Monument[] = [
  ...
  { id: 13, name: "Аргамач-Пальна",             type: "Природа",     period: "–",                lat: 52.5200, lng: 38.9800, desc: "Природно-исторический памятник на высоком берегу Быстрой Сосны." },
  { id: 14, name: "Центр романовской игрушки",  type: "Культура",    period: "XIX в.",            lat: 52.7100, lng: 39.1500, desc: "Центр возрождения романовской глиняной игрушки Липецкого края." },
];
